      ...
      >
        <Paper elevation={3} style={{ background: '#FFF' }}>
          ...
          <Grid container padding="1em" paddingTop="0">
            ...
            <Grid item xs={12} marginBottom="1em">
              ...
              <Typography variant="body1" display="inline">
                {event.Location.abbreviation + ', ' + event.locationDetails}
              </Typography>
            </Grid>
            <Grid item xs={12} marginBottom="1em">
              <Typography variant="h6" display="inline">
            ...
            <Grid item xs={12} marginBottom="1em">
              <Typography variant="h6" display="none">
                Food First Arrived:{' '}
              </Typography>
              <Typography variant="body1" display="none">
                {formatEventDateTime(event.foodArrived)}
              </Typography>
            </Grid>
            <Grid item xs={12} marginBottom="1em">
              <Typography variant="h6" display="inline">
              ...
              <Typography
                variant="body1"
                display="inline"
              >{`${formatEventDateTime(event.foodAvailable)} - ${formatEndTime(event)}`}</Typography>
            </Grid>
            <Grid item xs={12} marginBottom="1em">
          ...
          <Grid xs justifyContent="flex-end" paddingBottom="2em">
            {user &&
              user.role === 'Admin' &&
              (user.events.includes(eventId) || isNew) &&
