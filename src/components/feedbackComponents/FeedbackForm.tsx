...
export const FeedbackForm: React.FC<FeedbackFormProps> = ({
  ...
  const validateForm = () => {
    ...
    if (shareContact && !name && !email) {
      alert(
        'Please provide either your name or email if you wish to share your contact information.',
      );
      return false;
    }
    return true;
  ...
  return (
    <div style={{ background: '#FFF6EE' }}>
      ...
      >
        <Paper
          elevation={3}
          style={{ padding: '1em', paddingTop: '0.5em', paddingLeft: '0em' }}
        >
          ...
          <Grid container paddingLeft="1em">
            ...
            <Grid item textAlign={'left'} marginTop={1} xs>
              <Typography variant="h6">
                Please provide feedback on how we can improve the food pickup
                process
              </Typography>
            </Grid>
            <Grid item xs={12} marginTop={1}>
            ...
            <Grid container xs={12} alignItems="center" marginTop={1}>
              <FormControlLabel
                ...
                label={
                  <Typography alignSelf="center" fontSize="0.8em">
