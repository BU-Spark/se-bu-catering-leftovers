...
const CollapsibleFAQItem: React.FC<FAQItemProps> = ({
  question,
  answer,
  isActive,
  onClick,
  ...
  const faqs: FAQCategory[] = [
    {
      ...
      items: [
        ...
        },
        {
          ...
          answer:
            'You can provide feedback on food pick up process under events section.',
        },
        {
      ...
      items: [
        {
          ...
          answer:
            "You can sign up by clicking the 'Sign Up' button on the home page and selecting your role as a Student.",
        },
        {
          question: 'Can I receive notifications for specific campuses?',
          answer:
            'Yes, you can customize your notification preferences in the settings.',
        },
        {
          question: 'Is there a specific time limit to pick up food?',
          answer:
            'Yes, you must pick up food within 30 minutes of receiving a notification.',
        },
      ],
    },
    {
      ...
      items: [
        {
          question: 'How do I sign up for an account?',
          answer:
            "You can sign up by clicking the 'Sign Up' button on the home page and selecting your role as an Administrator.",
        },
        {
          question: 'Can I edit the posts that are published?',
          answer:
            'Yes, you can edit posts by first click on your event, then click on the red pen located on the top left of the page.',
        },
        {
          question: "Where can I view students' feedback?",
          answer:
            "You can view students' feeback at the end of the event details.",
        },
        {
