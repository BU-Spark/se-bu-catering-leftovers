      ...
      <Container maxWidth="sm" sx={{ padding: '1em', paddingTop: '7em' }}>
        <Paper elevation={3} sx={{ padding: '2rem' }}>
          ...
          {isEditing ? (
            ...
            <Box sx={{ mt: 2 }}>
              <Typography variant="h6" marginTop="2em">
                Name
              </Typography>
          ...
          <Typography variant="h6" marginTop="2em">
            Notify me with events in:
          </Typography>
          <Box
            justifyContent="center"
            sx={{ display: 'flex', flexWrap: 'wrap', mt: '1em', mb: '2em' }}
          >
            {['East', 'Central', 'West', 'South', 'All'].map((preference) => (
              <Chip
                ...
                label={preference}
                color={
                  campusPreferences.includes(preference) ? 'primary' : 'default'
                }
                ...
                sx={{
                  ...
                  borderWidth: '2px',
                  borderStyle: 'solid',
                  backgroundColor: campusPreferences.includes(preference)
                    ? '#ab0101'
                    : 'transparent',
                  color: campusPreferences.includes(preference)
                    ? '#fff'
                    : '#ab0101',
                  '&:hover': {
                    backgroundColor: campusPreferences.includes(preference)
